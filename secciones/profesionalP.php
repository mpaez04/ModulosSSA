...
$apellidop=isset($_POST['apellidop'])?$_POST['apellido']:'';
$apellidom=isset($_POST['apellidos'])?$_POST['apellidos']:'';

$correo=isset($_POST['cursos'])?$_POST['cursos']:'';
...
if($accion!=""){
    switch($accion){
        case 'agregar':
            ...
            $consulta->bindParam(':nivelTecnico',$nivelTecnico);
            $consulta->bindParam(':nivelCertificacion',$nivelCertificacion);
            $consulta->bindParam(':capacitacion',$capacitacion);
            $consulta->bindParam(':experiencia',$experiencia);
